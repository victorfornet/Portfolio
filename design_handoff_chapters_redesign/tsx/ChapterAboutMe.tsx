// components/chapters/ChapterAboutMe.tsx (Chapter V — how I work, what I value.)
"use client";
import { useRef } from "react";
import { motion, useReducedMotion, useTransform } from "framer-motion";
import { CHAPTERS, VALUES_GROUPED } from "@/content/chapters";
...
export function ChapterAboutMe() {
  ...
  return (
    <section
      ref={ref}
      id="about-me"
      className="relative isolate flex min-h-screen items-stretch bg-white"
    >
      <Numeral size={380} position={{ bottom: -100, right: -30 }}>V</Numeral>
      ...
      <div className="relative z-10 flex h-full w-full flex-col gap-5 px-16 py-12">
        <div className="flex items-end justify-between">
          ...
          >
            ...
            <h2 className="text-[96px] font-semibold leading-[0.98] tracking-[-0.03em] text-slate-900">
              how I <em className="font-serif font-normal italic text-sky-700">work,</em><br />
              what I <em className="font-serif font-normal italic text-sky-700">value.</em>
            </h2>
          </motion.div>
          <span
        ...
        <motion.div
          ...
          className="mt-2 grid grid-cols-2 gap-x-12"
        >
